...
std::vector<dana::core::LinkPtr> Combination::combine (dana::core::UnitPtr dst,dana::core::LayerPtr src1,dana::core::LayerPtr src2)
{
    std::vector<dana::core::LinkPtr> links;
    return links;
}
...
std::vector<dana::core::LinkPtr> Linear::combine (dana::core::UnitPtr dst,dana::core::LayerPtr src1,dana::core::LayerPtr src2)
{
