...
def empty(shape, dtype=float, order='C'):
    ...
    * :meth:`dana.core.zeros` : Return a new group setting values to zero.
    * :meth:`dana.core.ones` : Return a new group setting values to one.
    * :meth:`dana.core.zeros_like` : Return a group of zeros with shape and type of input.
    * :meth:`dana.core.ones_like` : Return a group of ones with shape and type of input.
    * :meth:`dana.core.empty_like` : Return a empty group with shape and type of input.
...
def zeros(shape, dtype=float, order='C'):
    ...
    * :meth:`dana.core.ones` : Return a new group setting values to one.
    * :meth:`dana.core.empty` : Return a new uninitialized group.
    * :meth:`dana.core.zeros_like` : Return an group of zeros with shape and type of input.
    * :meth:`dana.core.ones_like` : Return an group of ones with shape and type of input.
    * :meth:`dana.core.empty_like` : Return an empty group with shape and type of input.
...
def zeros_like(other):
    ...
    * :meth:`dana.core.ones` : Return a new group setting values to one.
    * :meth:`dana.core.empty` : Return a new uninitialized group.
    * :meth:`dana.core.empty_like` : Return an uninitialized group shape and type of input.
    * :meth:`dana.core.ones_like` : Return a group of ones with shape and type of input.
...
if __name__ == '__main__':
    Z = group((3, 3), dtype=[('x', float), ('y', float)])
    Z.x = Z.y =0
    print Z('x')
    print Z('x').base
