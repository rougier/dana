...
#ifndef __DANA_GL_ARRAYBAR_H__
#define __DANA_GL_ARRAYBAR_H__
...
namespace dana { namespace gl {
    class ArrayBar {
        public:
            ...
            Colormap        surface_cmap; // Surface colormap
            Colormap        line_cmap;    // Line colormap
        ...
        public:
            ...
            void Cube (float x, float y, float z, float dx, float dy, float dz);
